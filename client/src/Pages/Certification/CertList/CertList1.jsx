  ...
  return (
    <>
      <div className="mt-4 ">
        ...
        <div class="relative ">
          <img src={image.c1} alt="Example" className="w-full rounded-xl h-full shadow-xl  object-cover" />
          <div class="absolute inset-0 p-2 gap-2 flex rounded-xl flex-col items-start justify-end bg-black bg-opacity-50">
            <p class="text-white capitalize text-2xl font-bold">Auditing & System Certification</p>
            <button className=" "
